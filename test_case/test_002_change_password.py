...
class Test_change_password(object):
    ...
    def test_update_password_system_success(self, id, name, change_pwd, change_phone, login_pwd, login_phone, userId):
        ...
        with allure.step("step2: 步骤2 ==>> 系统管理员直接开始修改其他人的密码为原密码+‘123’"):
            r1 = user.change_password(cookies, id=id, name=name, password=change_pwd + '123',
        ...
        if login_phone == change_phone:
            ...
            with allure.step("step5: 步骤5 ==>> 用户再把自己的密码由原密码+‘123’变回原密码"):
                r3 = user.change_password(cookies2, id=id, name=name, password=login_pwd, phone=login_phone,
            ...
            with allure.step("step5: 步骤5 ==>> 系统管理员再把各用户的密码由原密码+‘123’变回原密码"):
                r3 = user.change_password(cookies2, id=id, name=name, password=change_pwd, phone=login_phone,
                                          token=token2, userid=userId)
    ...
    def test_update_password_no_login(self, id, name, change_pwd, login_pwd, phone, userId):
        ...
        with allure.step("step2: 步骤2 ==>> 直接修改密码"):
            r = user.change_password(None, id=id, name=name, password=change_pwd, userid=userId, token=token)
