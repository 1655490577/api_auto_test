...
def add_user():
    ...
    for i in range(1, 5):
        getter.user_save(cookies, dataType=1, isAdmin=1, name=f"测试系统管理员0{i}", password="123456", phone=str(13100000000+i),
                         proSelected=[], roleId=sysRoleId, state=1, token=token, userid=userId)  # 添加测试系统管理员01-04

        getter.user_save(cookies, dataType=1, isAdmin=2, name=f"测试公司管理员0{i}", password="123456", phone=str(13100000004+i),
        ...
        getter.user_save(cookies, dataType=1, isAdmin=2, name=f"测试部门用户0{i}", password="123456", phone=str(13100000008+i),
                         proSelected=["272459479822368768"], projects="272459479822368768",
        ...
        getter.user_save(cookies, dataType=1, isAdmin=2, name=f"测试组用户0{i}", password="123456", phone=str(13100000012+i),
                         proSelected=["272459479822368768"], projects="272459479822368768",
