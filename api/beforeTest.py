...
def add_test_user():
    ...
    user.user_save(cookies, dataType=1, isAdmin=1, name="测试系统管理员01", password="123456", phone="13168775501",
                   roleId="259752668312895488", state=1, token=token, userid="259098505857990656")  # 添加测试系统管理员01

    user.user_save(cookies, dataType=1, isAdmin=1, name="测试系统管理员02", password="123456", phone="13168775502",
                   roleId="259752668312895488", state=1, token=token, userid="259098505857990656")  # 添加测试系统管理员02

    user.user_save(cookies, dataType=1, isAdmin=2, name="测试公司管理员01", password="123456", phone="13168775503",
    ...
    user.user_save(cookies, dataType=1, isAdmin=2, name="测试公司管理员02", password="123456", phone="13168775504",
                   roleId="259821125242978304", state=1, token=token, userid="259098505857990656",
                   dicCode="0102", dicId="259718019809280000", dicName="测试公司")  # 添加测试公司管理员02

    user.user_save(cookies, dataType=1, isAdmin=2, name="测试部门用户01", password="123456", phone="13168775505",
    ...
    user.user_save(cookies, dataType=1, isAdmin=2, name="测试部门用户02", password="123456", phone="13168775506",
                   roleId="259720390136299520 ", state=1, token=token, userid="259098505857990656",
                   branchCode="010201", branchId="259718102269296640", branchName="工程部01", dicCode="0102",
                   dicId="259718019809280000", dicName="测试公司")  # 添加测试部门用户02

    user.user_save(cookies, dataType=1, isAdmin=2, name="测试组用户01", password="123456", phone="13168775507",
    ...
    user.user_save(cookies, dataType=1, isAdmin=2, name="测试组用户02", password="123456", phone="13168775508",
                   roleId="259720526056914944 ", state=1, token=token, userid="259098505857990656",
                   branchCode="010201", branchId="259718102269296640", branchName="工程部01", dicCode="0102",
                   dicId="259718019809280000", dicName="测试公司", groupCode="01020101", groupId="259718194518818816",
